...
int CoppeliaSim::SendControlMsg_run(void)
{
    ...
    LOG(INFO) << "SendControlMsg start" << endl;
}
...
int CoppeliaSim::CoppeliaSim_run(void)
{
    ...
    LOG(INFO) << "Coppelisam_run start .." << endl;
    ...
    while (true)
    {
        // LOG(INFO) << "Coppelisam_run start, Circular " << endl;
        ...
        // LOG(INFO) << "copSim2main , diff=" << diff << " s" << endl;
        ...
        if (ret > 0)
        {
            ...
            // LOG(INFO) << "before invert:msg_copSim2main.CoppSimmsg2Human.POS_X = " << setprecision(12) << msg_copSim2main.CoppSimmsg2Human.POS_X << endl;
            // LOG(INFO) << "before invert:msg_copSim2main.CoppSimmsg2Human.POS_Y = " << setprecision(12) << msg_copSim2main.CoppSimmsg2Human.POS_Y << endl;
            // LOG(INFO) << "before invert:msg_copSim2main.CoppSimmsg2Human.POS_Z = " << setprecision(12) << msg_copSim2main.CoppSimmsg2Human.POS_Z << endl;
            ...
            // LOG(INFO) << "After invert: latitude = " << setprecision(12) << InvertSimPos[0] << endl;
            // LOG(INFO) << "After invert: longitude = " << setprecision(12) << InvertSimPos[1] << endl;

            // cout << "After invert:纬度 latitude = " << InvertSimPos[0] << endl;
            // cout << "After invert:经度 longitude = " << InvertSimPos[1] << endl;

            // LOG(INFO) << "before invert:msg_copSim2main.CoppSimmsg2Human.roll_new = " << setprecision(6) << msg_copSim2main.CoppSimmsg2Human.roll_new << endl;
            // LOG(INFO) << "before invert:msg_copSim2main.CoppSimmsg2Human.pitch_new  = " << setprecision(6) << msg_copSim2main.CoppSimmsg2Human.pitch_new << endl;
            // LOG(INFO) << "before invert:msg_copSim2main.CoppSimmsg2Human.yaw_new = " << setprecision(6) << msg_copSim2main.CoppSimmsg2Human.yaw_new << endl;
            ...
            // LOG(INFO) << "After invert:roll_new = " << setprecision(6) << InvertSimATT[0] << endl;
            // LOG(INFO) << "After invert:pitch_new  = " << setprecision(6) << InvertSimATT[1] << endl;
            // LOG(INFO) << "After invert:yaw_new = " << setprecision(6) << InvertSimATT[2] << endl;
            ...
            // LOG(INFO) << "After invert:latitude = " << setprecision(12) << InvertSimPos[0] << endl;
            // LOG(INFO) << "After invert:longitude  = " << setprecision(12) << InvertSimPos[1] << endl;
            // LOG(INFO) << "After invert:heading = " << setprecision(12) << InvertSimATT[2] << endl;
            GPSPOS_flag_mtx.unlock();
        }
        else
        {
            LOG(INFO) << "[WARNING] msgrcv return ret = " << ret << endl;
        }
    }
    return true;
}
